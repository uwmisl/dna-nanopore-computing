...
Loading Data
'''
Y_file = np.load(os.path.join(data_dir, 'all_36_barcodes_classes.npy'))
X_file = np.load(os.path.join(data_dir, 'all_36_barcodes_raw_windows.npy'))
...
text_file = open("all_36_barcodes_cnn_results_20210730.txt", "w")
...
'''
torch.save(net.state_dict(), "all_36_barcodes_trained_cnn_20210730.pt")
